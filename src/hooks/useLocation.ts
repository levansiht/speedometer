...
import {getCurrentLocation, watchPosition} from '../services/GPSService';
import {
  ...
  useEffect(() => {
    const checkPermissions = async () => {
      ...
      if (hasPermission) {
        ...
        setPermission(PermissionStatus.DENIED);
      ...
      console.log('useLocation: Permission status:', {
